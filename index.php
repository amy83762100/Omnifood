...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    <img src="resources/css/img/logo-white.png" alt="Omnifood" class="logo">
                    <img src="resources/css/img/logo.png" alt="Omnifood" class="logo-black">
                    ...
                    <a class="mobile-nav-icon js--nav-icon"><ion-icon id="icon" name="menu-outline"></ion-icon></a>
                </div>
            </nav>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    <div class="works-step">
                        <div>1</div>
                        <p>Choose the subscrition plan that best fits your needs and sign up today.</p>
                    </div>
                    <div class="works-step">
                        <div>2</div>
                    ...
                    <a href="https://www.apple.com/app-store" target="_blank" class="btn-app"><img src="resources/css/img/download-app-store.png" alt="App Store Button"></a>
                    <a href="https://play.google.com/store" target="_blank" class="btn-play"><img src="resources/css/img/download-app-android.png" alt="Play Store Button"></a>
                </div>
            </div>
        </section>
        ...
        <section class="section-testimonials">
            <div class="row">
                <h2>Our customers cant's live without us</h2>
            </div>
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/css/img/customer-1.jpg" alt="customer">Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                       Inexpensive, healthy and great-tasting meals, delivered right to my home. 
                        ...
                        <cite><img src="resources/css/img/customer-2.jpg" alt="customer">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/css/img/customer-3.jpg" alt="customer">Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
        </section>
        ...
        <footer>
            <div class="row">
                <div class="col span-1-of-2">
                    <ul class="footer-nav">
                        <li><a href="https://blog.twitter.com" target="_blank">About us</a></li>
                        <li><a href="https://blog.twitter.com" target="_blank">Blog</a></li>
                ...
                <div class="col span-1-of-2">
                    <ul class="footer-social">
                        ...
                        <li><a href="https://twitter.com" target="_blank"><ion-icon name="logo-twitter"></ion-icon></a></li>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2021 by Omnifood. All right reserved.
                </p>
            </div>
        </footer>

        
        <script src="//cdn.jsdelivr.net/respond/1.4.2/respond.min.js"></script> <!-- enable browsers to understand and execute media queries -->
        <script src="//cdn.jsdelivr.net/html5shiv/3.7.2/html5shiv.min.js"></script> <!-- available HTML5 in older browser -->
        <script src="//cdn.jsdelivr.net/selectivizr/1.0.3b/selectivizr.min.js"></script> <!-- allow us to use CSS3 pseudo-class and attribute in IE6-8. -->
        <script src="vendors/js/jquery.waypoints.min.js"></script> 

        <script async
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDvT2PXOUEfBN-u3gvPU2ZauNETPgr4qMo&callback=initMap">
        </script>
        
        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-RHTNRRT0FP"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-RHTNRRT0FP');
        </script>
